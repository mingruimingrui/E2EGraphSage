"""
This script is a duplicate of
https://github.com/pytorch/pytorch/blob/v1.1.0/torch/utils/data/_utils/worker.py
This script contains the _worker_loop fn for data_loader_2
"""
...
from torch.utils.data._utils import collate, signal_handling, \
    MP_STATUS_CHECK_INTERVAL, ExceptionWrapper, IS_WINDOWS
